...
try {
    ...
    //DB에 저장된 데이터 불러오는 과정
     ...
     while(rs.next()){
      ...
      String strXML=" ";
       strXML+="<CONTENT_TABLE>";
       strXML+= "<person>";
       strXML+= "<content_location>"+ content_location +"</content_location>";
       strXML+= "<content_lat>"+ content_lat +"</content_lat>";
       strXML+= "<content_lng>"+ content_lng +"</content_lng>";
       strXML+= "</person>";
       strXML+="</CONTENT_TABLE>";
       out.write(strXML); //데이터 요청하는 곳으로 보내준다. 
}
con.close();
st.close();
